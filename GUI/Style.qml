...
// Design tokens for the settings UI. Copied from the caelestia-kde-plugins
// `web-cursor-settings` plugin so the standalone app shares the same look,
// metrics and motion.
import QtQuick
...
QtObject {
    ...
    readonly property int paddingLargeIncreased: 28
